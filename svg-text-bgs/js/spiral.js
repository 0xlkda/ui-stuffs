...
export class Spiral {
  ...
  lineIntersection(slope1, yIntercept1, slope2, yIntercept2) {
    if (slope1 === slope2) {
      throw new Error('Parallel lines do not intersect.')
    }
    
    const xCoordinate = (yIntercept2 - yIntercept1) / (slope1 - slope2)
    const yCoordinate = slope1 * xCoordinate + yIntercept1
